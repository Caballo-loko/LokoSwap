...
impl<'info> Withdraw<'info> {
    ...
    pub fn withdraw(
        ...
        let (x, y) = if self.mint_lp.supply == amount && self.vault_x.amount > 0 && self.vault_y.amount > 0 {
            // If withdrawing all liquidity, return all tokens
        ...
        // Then withdraw tokens from vault
